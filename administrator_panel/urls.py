...
urlpatterns = [
    ...
    path('cabinet/receipt/print/<int:receipt_pk>/', OwnerReceiptToPrint.as_view(), name='owner-receipt-print'),
    path('cabinet/receipt/convert-to-pdf', ReceiptToPDFDetailView.as_view(), name='receipt-to-pdf'),
